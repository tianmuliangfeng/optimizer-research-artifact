...
LAUNCHER="${ROOT}/commands/mdp04_refresh_streaming/20260803_mdp04_refresh_streaming.sh"
: "${MDP04_RUN_DIR:?Set MDP04_RUN_DIR to the archived MDP-04 result directory}"
export SNM_ARTIFACT_ROOT="${SNM_ARTIFACT_ROOT:-${ROOT}}"
bash "${LAUNCHER}" archive-verify
