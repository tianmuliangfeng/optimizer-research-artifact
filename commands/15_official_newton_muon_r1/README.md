# Commands for 15 Official Newton Muon R1

- Status: `implemented`
- Code: `../../scripts/15_official_newton_muon_r1`
...
```bash
python reproducibility/reproduce.py inspect 15_official_newton_muon_r1
```
...
```bash
python reproducibility/reproduce.py reproduce 15_official_newton_muon_r1
```
...
python reproducibility/reproduce.py verify \
  15_official_newton_muon_r1 --results-root /path/to/results \
  --run-dir /path/to/results/15_official_newton_muon_r1/RUN_ID
```

## Entrypoints

- `script:run_official_newton_muon_r1` -> `scripts/15_official_newton_muon_r1/run_official_newton_muon_r1.py` (reproduce)
