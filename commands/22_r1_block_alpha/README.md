# Commands for 22 R1 Block Alpha

- Status: `implemented`
- Code: `../../scripts/22_r1_block_alpha`
...
```bash
python reproducibility/reproduce.py inspect 22_r1_block_alpha
```
...
```bash
python reproducibility/reproduce.py reproduce 22_r1_block_alpha
```
...
python reproducibility/reproduce.py verify \
  22_r1_block_alpha --results-root /path/to/results \
  --run-dir /path/to/results/22_r1_block_alpha/RUN_ID
```

## Entrypoints

- `command:20260727_r1_block_alpha_confirmatory_multiseed` -> `commands/22_r1_block_alpha/20260727_r1_block_alpha_confirmatory_multiseed.sh` (reproduce)
- `script:run_confirmatory_batch` -> `scripts/22_r1_block_alpha/run_confirmatory_batch.py` (explicit selection only)
- `script:run_r1_block_alpha` -> `scripts/22_r1_block_alpha/run_r1_block_alpha.py` (explicit selection only)
