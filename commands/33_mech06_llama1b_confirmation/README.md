# Commands for 33 Mech06 Llama1B Confirmation

- Status: `implemented`
- Code: `../../scripts/33_mech06_llama1b_confirmation`
...
```bash
python reproducibility/reproduce.py inspect 33_mech06_llama1b_confirmation
```
...
```bash
python reproducibility/reproduce.py reproduce 33_mech06_llama1b_confirmation
```
...
python reproducibility/reproduce.py verify \
  33_mech06_llama1b_confirmation --results-root /path/to/results \
  --run-dir /path/to/results/33_mech06_llama1b_confirmation/RUN_ID
```

## Entrypoints

- `command:20260727_mech06_llama1b_confirmation` -> `commands/33_mech06_llama1b_confirmation/20260727_mech06_llama1b_confirmation.sh` (reproduce)
- `script:run_mech06` -> `scripts/33_mech06_llama1b_confirmation/run_mech06.py` (explicit selection only)
