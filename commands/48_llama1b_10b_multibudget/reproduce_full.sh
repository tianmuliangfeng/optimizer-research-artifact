...
LAUNCHER="${ROOT}/commands/48_llama1b_10b_multibudget/20260805_ex48_llama1b_10b_multibudget.sh"
RESULTS="${SNM_RESULTS_ROOT:-${ROOT}/runs}"
STAMP="$(date -u +%Y%m%dT%H%M%S+0000)"

export SNM_ARTIFACT_ROOT="${SNM_ARTIFACT_ROOT:-${ROOT}}"
export EX48_RUN_DIR="${EX48_RUN_DIR:-${RESULTS}/48_llama1b_10b_multibudget/${STAMP}}"
bash "${LAUNCHER}" check
