# Commands for 36 Mech08 Short Horizon Rollout

- Status: `implemented`
- Code: `../../scripts/36_mech08_short_horizon_rollout`
...
```bash
python reproducibility/reproduce.py inspect 36_mech08_short_horizon_rollout
```
...
```bash
python reproducibility/reproduce.py reproduce 36_mech08_short_horizon_rollout
```
...
python reproducibility/reproduce.py verify \
  36_mech08_short_horizon_rollout --results-root /path/to/results \
  --run-dir /path/to/results/36_mech08_short_horizon_rollout/RUN_ID
```

## Entrypoints

- `command:20260727_mech08_short_horizon_rollout` -> `commands/36_mech08_short_horizon_rollout/20260727_mech08_short_horizon_rollout.sh` (reproduce)
- `script:run_mech08` -> `scripts/36_mech08_short_horizon_rollout/run_mech08.py` (explicit selection only)
