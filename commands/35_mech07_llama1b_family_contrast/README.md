# Commands for 35 Mech07 Llama1B Family Contrast

- Status: `implemented`
- Code: `../../scripts/35_mech07_llama1b_family_contrast`
...
```bash
python reproducibility/reproduce.py inspect 35_mech07_llama1b_family_contrast
```
...
```bash
python reproducibility/reproduce.py reproduce 35_mech07_llama1b_family_contrast
```
...
python reproducibility/reproduce.py verify \
  35_mech07_llama1b_family_contrast --results-root /path/to/results \
  --run-dir /path/to/results/35_mech07_llama1b_family_contrast/RUN_ID
```

## Entrypoints

- `command:20260727_mech07_llama1b_family_contrast` -> `commands/35_mech07_llama1b_family_contrast/20260727_mech07_llama1b_family_contrast.sh` (reproduce)
- `script:run_mech07` -> `scripts/35_mech07_llama1b_family_contrast/run_mech07.py` (explicit selection only)
