...
GPT_MECH02="${SNM_RESULTS_ROOT}/30_mech02_k_geometry/llama_host_endpoint/20260727T051732+0000/gpt_bridge_endpoint/formal"
...
L124_MECH02="${SNM_RESULTS_ROOT}/30_mech02_k_geometry/llama_host_endpoint/20260727T051732+0000/llama124_endpoint/formal"

STAMP="$(date -u +%Y%m%dT%H%M%S+0000)"
ROOT="${SNM_RESULTS_ROOT}/31_mech03_crossfit_shadow/llama_host_endpoint/$STAMP"
...
run_family() {
  ...
  echo "MECH-03 family PASS: $family"
}
