# OpenWebText GPT-2-tokenized 50M-token subset, tier4 depth-scaling run.

out_dir = "out_openwebtext_gpt2_50m_tier4"
eval_interval = 500
eval_iters = 20
log_interval = 20
...
wandb_log = True
wandb_project = "Selective-Newton-Muon-OWT-LargeModel"
wandb_run_name = "owt_50m_tier4_newton_muon"
wandb_mode = "online"
wandb_group = "owt_50m_tier4"
wandb_tags = "formal,openwebtext_gpt2_50m,tier4,selective_newton_muon,large_model_scale"
