...
out_dir = "out_28_oracle_static_release15"
wandb_run_name = "oracle_static_release15"
wandb_tags = "formal,openwebtext_gpt2,selective_newton_muon,oracle_static,storage_pareto"

selective_selection_mode = "oracle_static"
selective_static_mask_path = os.path.join(
    os.environ.get("SNM_RESULTS_ROOT", "../../runs"),
    "analysis_exports/owt_tier1_memopt_20260706/wandb_export_2026-07-06T12_15_09.261+08_00.csv",
)
selective_static_mask_seed = -1
selective_static_mask_run_name = ""
selective_static_mask_target_release_k_fraction = 0.15
