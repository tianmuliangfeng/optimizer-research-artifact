# OpenWebText GPT-2-tokenized subset, model tier 3 scaling smoke.

out_dir = "out_openwebtext_gpt2_tier3"
eval_interval = 200
eval_iters = 10
log_interval = 10
...
wandb_run_name = "owt_tier3_newton_muon"
wandb_mode = "online"
wandb_group = "owt_tier3"
wandb_tags = "formal,openwebtext_gpt2,tier3,selective_newton_muon,storage_scaling"
