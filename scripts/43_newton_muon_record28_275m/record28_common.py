#!/usr/bin/env python3
"""Shared, dependency-light utilities for experiment 43.
...
METADATA_PREFIX = "RECORD28_METADATA "
MEMORY_PREFIX = "RECORD28_FINAL_AUDIT "
VALIDATION_PREFIX = "RECORD28_VAL "
WARMUP_RESET_PREFIX = "RECORD28_WARMUP_RESET "
...
def cell_key(stage: str, seed: int, method: str) -> str:
    ...
    return f"experiment43:{stage}:seed{seed}:{method}"
...
def stable_wandb_id(stage: str, seed: int, method: str, contract_sha256: str) -> str:
    ...
    return f"rec28-{seed}-{method[:12]}-{digest}"
