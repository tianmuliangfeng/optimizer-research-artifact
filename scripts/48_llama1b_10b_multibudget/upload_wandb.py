...
def main() -> int:
    ...
    run_name = f"ex48_{phase['budget_id']}_{method}_seed{seed}"
    try:
        import wandb
        ...
        run = wandb.init(
            ...
            tags=["ex48", "llama1b", "fineweb10B", "long-token", "formal"],
        ...
        payload: dict[str, Any] = {
            "schema_version": "ex48_wandb_upload_v1",
            "status": "uploaded",
            "mode": args.mode,
            "project": args.project,
            "entity": args.entity,
