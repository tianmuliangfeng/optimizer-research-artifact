...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run publication 24L/300M-ish scale-up experiments.")
    ...
    parser.add_argument("--wandb-project", default="Selective-Newton-Muon-MainConf-ScaleUp")
    ...
    parser.add_argument("--run-prefix", default="mainconf_scale_300m")
...
def build_commands(args: argparse.Namespace, middle_mask: str | None, release_all_mask: str | None) -> list[list[str]]:
    ...
    tags = (
        f"publication,{args.dataset},scale_up_300m,"
    ...
    for seed in args.seeds:
        ...
        for method in args.methods:
            if method in ("muon", "newton"):
                ...
                run_name = f"{args.run_prefix}_L{args.n_layer}_D{args.n_embd}_{method_label}_seed{seed}"
