...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run 12L long-token-budget publication checks.")
    ...
    parser.add_argument("--wandb-project", default="Selective-Newton-Muon-MainConf-LongBudget")
    ...
    parser.add_argument("--run-prefix", default="mainconf_long_budget_100m")
...
def build_commands(args: argparse.Namespace, middle_mask: str | None, release_all_mask: str | None) -> list[list[str]]:
    ...
    tags = (
        f"publication,{args.dataset},long_budget,"
